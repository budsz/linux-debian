...
WORKDIR="M-ONE"
BASEDIR="/home/`whoami`/$WORKDIR/FIN"
...
if [ -n "$vs12xx" ]; then
    ...
    do
        yt-dlp $YTOPT -f $vr12xx -o "vid-$IDX.mp4" $URL
    ...
    do
        yt-dlp $YTOPT -f $vr8xx -o "vid-$IDX.mp4" $URL
    ...
    do
        yt-dlp $YTOPT -f $vr6xx -o "vid-$IDX.mp4" $URL
    ...
    do
        yt-dlp $YTOPT -f $vr3xx -o "vid-$IDX.mp4" $URL
